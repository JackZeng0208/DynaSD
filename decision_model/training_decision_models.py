...
from DynaSD.inference.decision_models import *
...
class TrainDecisionModel:
    def __init__(self,
        ...
        self.weight_save_path = decision_model_save_path+f'high_quality_soft_{DECISION_MODEL_NAME}.pt'
    ...
    def generate_data(self,accept_training_example = 700):
        ...
        val_x,val_y = [],[]
        for vs in tqdm(self.dataset[self.train_val_split:self.train_val_split +100]):
