...
class BalancedDataset(Dataset):
    def __init__(self, data_file, label_file):
        ...
        print(f"shape of self.data {len(self.data)}")
...
class TrainDecisionModel:
    def __init__(self,
        strategy,
        training_data_file_name = '/home/iasl-transformers/UCI-IASL-Transformer/training_datasets/combined_training_questions.json',
        training_epoch = 10,
        learning_rate = 0.01,
        batch_size = 30, # the batch size should be carefully chosen for easy code implementation since no torch.dataset is using
        train_without_save_data = True,
        decision_model_save_path = '/home/iasl-transformers/UCI-IASL-Transformer/naive_speculative_decoding_dynamic_depth/decision_model_experiments/',
                 ) -> None:
        self.decision_model = DecisionModelV2l().cuda()
        self.loss_file = 'loss_v2l.png'
        self.weight_save_path = decision_model_save_path+'decision_model_v2l.pt'
        ...
        self.new_dataset_base = '/home/iasl-transformers/UCI-IASL-Transformer/naive_speculative_decoding_dynamic_depth/decision_model_experiments/soft_label/'
        ...
        # Training Strategy
        self.generated_training_dataset_path = "/home/iasl-transformers/UCI-IASL-Transformer/naive_speculative_decoding_dynamic_depth/decision_model_experiments/training_data_tensor_x.pt"
        self.generated_label_dataset_path = "/home/iasl-transformers/UCI-IASL-Transformer/naive_speculative_decoding_dynamic_depth/decision_model_experiments/training_data_tensor_y.pt"
        self.train_without_save_data = train_without_save_data
        self.validation_dataset_x_path = '/home/iasl-transformers/UCI-IASL-Transformer/naive_speculative_decoding_dynamic_depth/decision_model_experiments/validation_data_tensor_x.pt'
        self.validation_dataset_y_path = '/home/iasl-transformers/UCI-IASL-Transformer/naive_speculative_decoding_dynamic_depth/decision_model_experiments/validation_data_tensor_y.pt'
        ...
        self.pos_y_pred_file = '/home/iasl-transformers/UCI-IASL-Transformer/naive_speculative_decoding_dynamic_depth/decision_model_experiments/pos_ypred_list.pkl'
        self.neg_y_pred_file = '/home/iasl-transformers/UCI-IASL-Transformer/naive_speculative_decoding_dynamic_depth/decision_model_experiments/neg_ypred_list.pkl'
        ...
        self.postive_label_entropy_file = '/home/iasl-transformers/UCI-IASL-Transformer/naive_speculative_decoding_dynamic_depth/decision_model_experiments/entropy_decision/postive_entropy.pkl'
        self.negative_label_entropy_file = '/home/iasl-transformers/UCI-IASL-Transformer/naive_speculative_decoding_dynamic_depth/decision_model_experiments/entropy_decision/negative_entropy.pkl'
    ...
    def append_to_tensor_dataset(self,new_tensors,is_label = False,is_val= False):
        ...
        try:
            ...
            print(f"File {path} not found. Creating a new dataset.")
            existing_dataset = []

        # Ensure existing_dataset is a list
    ...
    def generate_data(self,accept_training_example = 1000000):
        ...
        val_x,val_y = [],[]
        for vs in tqdm(self.dataset[self.train_val_split+110:self.train_val_split +400]):
    ...
    def only_eval(self):
        val_dataset = BalancedDataset(self.soft_val_x_path,self.soft_val_y_path)
    ...
    def train_with_dataset(self):
        train_dataset = BalancedDataset(self.soft_train_x_path,self.soft_train_y_path)
