...
def mcsd_inference(target_model_name, draft_model_name, prompts, max_new_tokens=max_new_tokens, draft_model_temp = 0, target_model_temp = 0,replacement=replacement, speculative_sampling=speculative_sampling, tree_attn=tree_attn):
    ...
    for sampling_method in sampling_methods:
        ...
        for target_model in target_model_names:
            for draft_model in draft_model_names:
                ...
                token_per_second, acc_rate = mcsd_inference(target_model_name=target_model, draft_model_name=draft_model, prompts=prompts, draft_model_temp=draft_model_temp, target_model_temp=target_model_temp)
        ...
        with open(f'mcsd_inference_{dataset_name}_{sampling_method}.csv', mode='w') as file:
