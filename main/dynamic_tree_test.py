...
class HeteroSpeculativeDecoding:
    ...
    def edge_tree_attn_speculative_decoding(
        ...
        while input_ids.shape[1] < T:
            ...
            })  # cand probs needed for naive tree_attn
    ...
    def server_tree_attn_speculative_decoding(
        ...
        (Maybe consider using an abstract class that only stores temperature and devices, changing functions to class methods)
        ...
        with open(f"gpu_utilization_MCSD.csv", mode='w', newline='') as file:
            ...
            while True:
                ...
                # TODO: compare entropy between each prediction step with entropy of logits generated from draft model
